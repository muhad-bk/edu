...
@InputType()
class ConfigurableModuleCreateInput {
  @ApiProperty({
    required: false,
    type: String,
  })
  ...
  @ApiProperty({
    required: false,
    type: () => SubscriptionCreateNestedManyWithoutConfigurableModulesInput,
  })
  @ValidateNested()
  @Type(() => SubscriptionCreateNestedManyWithoutConfigurableModulesInput)
  @IsOptional()
  @Field(() => SubscriptionCreateNestedManyWithoutConfigurableModulesInput, {
    nullable: true,
  })
  subscriptionsConfigModules?: SubscriptionCreateNestedManyWithoutConfigurableModulesInput;
}

export { ConfigurableModuleCreateInput };
